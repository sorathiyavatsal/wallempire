                        ...
                        <Carousel responsive={responsive} className='pt-10'>
                            <div className="flex items-center md:mr-5" >
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="http://wall-empire.com/demo/wp-content/uploads/2020/12/WE3422-3.jpg" layout="fill" className="rounded-lg shadow-xl w-full hover:shadow-2xl h-96 object-cover" />
                            ...
                            <div className="flex items-center md:mr-5">
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="http://wall-empire.com/demo/wp-content/uploads/2020/12/WE3425-3.jpg" layout="fill" className="rounded-lg shadow-xl w-full hover:shadow-2xl h-96 " />
                            ...
                            <div className="flex items-center md:mr-5">
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="http://wall-empire.com/demo/wp-content/uploads/2020/12/WE3487-3.jpg" layout="fill" className="rounded-lg shadow-xl w-full hover:shadow-2xl h-96" />
                                    <div className="absolute text-lg -mt-20 h-20 text-white px-4 bg-gradient-to-b from-transparent to-black w-full">
                                        <div>
                                            <h1>Curtains</h1>
                                        </div>
                            ...
                            <div className="flex items-center md:mr-5">
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="http://wall-empire.com/demo/wp-content/uploads/2020/12/WE3507-3.jpg" layout="fill" className="rounded-lg shadow-xl hover:shadow-2xl w-full h-96" />
                                    <div className="absolute text-lg -mt-20 h-20 text-white px-4 bg-gradient-to-b from-transparent to-black w-full">
                                        <div>
                                            <h1>Curtains</h1>
                                        </div>
                            ...
                            <div className="flex items-center md:mr-5">
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="http://wall-empire.com/demo/wp-content/uploads/2020/12/WE3464-3.jpg" layout="fill" className="rounded-lg shadow-xl w-full hover:shadow-2xl h-96" />
                                    <div className="absolute text-lg -mt-20 h-20 text-white px-4 bg-gradient-to-b from-transparent to-black w-full">
                                        <div>
                                            <h1>Curtains</h1>
                                        </div>
