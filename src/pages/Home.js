                ...
                <main className="max-w-7xl mx-auto px-8 sm:px-16">
                    ...
                    <section className="pt-20">
                        ...
                        <div className="grid md:grid-cols-2 grid-cols-1 gap-10 items-center">
                            <div>
                                <LazyLoadImage src="https://res.cloudinary.com/wall-empire/image/upload/v1650449711/images/21_ljtyka.jpg" layout="fill" className='rounded-lg' />
                            ...
                            <div>
                                <LazyLoadImage src="https://res.cloudinary.com/wall-empire/image/upload/v1650449677/images/20_mbj9cq.jpg" layout="fill" className='rounded-lg' />
                                <div className='pt-3 pl-5'>
                    ...
                    <section className="pt-20">
                        <div className="grid md:grid-cols-2 grid-cols-1 gap-2 items-center">
                            ...
                            <div>
                                <LazyLoadImage src="https://res.cloudinary.com/wall-empire/image/upload/v1650449645/images/09_o5hycv.jpg" layout="fill" className="rounded-lg" />
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="pt-20">
                        <div className="grid md:grid-cols-2 grid-cols-1 gap-2 items-center">
                            ...
                            <div>
                                <LazyLoadImage src="https://res.cloudinary.com/wall-empire/image/upload/v1650449596/images/05_ctlxnx.jpg" layout="fill" className="rounded-lg" />
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="pt-20">
                        ...
                        <Carousel responsive={responsive} className='pt-10'>
                            <div className="flex items-center md:mr-5" >
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="https://res.cloudinary.com/wall-empire/image/upload/v1650449415/images/WE3422-3_qeztri.jpg" layout="fill" className="rounded-lg shadow-xl w-full hover:shadow-2xl h-96 object-cover" />
                            ...
                            <div className="flex items-center md:mr-5">
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="https://res.cloudinary.com/wall-empire/image/upload/v1650449436/images/WE3425-3_gwnpjv.jpg" layout="fill" className="rounded-lg shadow-xl w-full hover:shadow-2xl h-96 " />
                            ...
                            <div className="flex items-center md:mr-5">
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="https://res.cloudinary.com/wall-empire/image/upload/v1650449454/images/WE3487-3_p2shgd.jpg" layout="fill" className="rounded-lg shadow-xl w-full hover:shadow-2xl h-96" />
                                    <div className="absolute text-lg -mt-20 h-20 text-white px-4 bg-gradient-to-b from-transparent to-black w-full">
                                        <div>
                                            <h1>Curtains</h1>
                                        </div>
                            ...
                            <div className="flex items-center md:mr-5">
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="https://res.cloudinary.com/wall-empire/image/upload/v1650449481/images/WE3507-3_v2j32z.jpg" layout="fill" className="rounded-lg shadow-xl hover:shadow-2xl w-full h-96" />
                                    <div className="absolute text-lg -mt-20 h-20 text-white px-4 bg-gradient-to-b from-transparent to-black w-full">
                                        <div>
                                            <h1>Curtains</h1>
                                        </div>
                            ...
                            <div className="flex items-center md:mr-5">
                                <figure className="relative max-w-xs cursor-pointer h-96 w-full">
                                    <LazyLoadImage src="https://res.cloudinary.com/wall-empire/image/upload/v1650449502/images/WE3464-3_hxvpgb.jpg" layout="fill" className="rounded-lg shadow-xl w-full hover:shadow-2xl h-96" />
                                    <div className="absolute text-lg -mt-20 h-20 text-white px-4 bg-gradient-to-b from-transparent to-black w-full">
                                        <div>
                                            <h1>Curtains</h1>
                                        </div>
